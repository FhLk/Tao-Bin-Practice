        ...
        <div className='rounded-xl bg-white h-[300px] px-10 py-5'>
            ...
            <div className='h-[100px] items-center my-3'>
                <ul className='space-y-7'>
                    <li className='flex items-center justify-between' onClick={()=>handleGetStraw(!isGetStraw)}>
                    ...
                    <li className='flex items-center justify-between' onClick={()=>handleGetLid(!isGetLid)}>
